...
- [x] **Results tab: items duplicate on fresh session load**
...
- [x] **Deletion modal: date sort is wrong order**
...
- [x] **Reprint from Manage Shipments modal should actually print**
...
- [x] **Label print size differs between build and development**
...
- [x] **Move `config.json` to AppData (survives updates)**
...
- [x] **Refresh single order after note added via fulfilment screen**
